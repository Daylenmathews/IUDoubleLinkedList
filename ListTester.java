 ...
 * get you started.
 *
 * @author mvail, mhthomas, awinters, Daylen Mathews
 */
@SuppressWarnings("deprecated")
public class ListTester {

    private Scenario<Integer> emptyList_ListIterAddA_A;
    //possible lists that could be tested
    private Scenario<Integer> emptyList_addToRearB_B;
    private Scenario<Integer> emptyList_add0B_B;
    private Scenario<Integer> emptyList_addC_C;
    private Scenario<Integer> emptyList_add0C_C;
    private Scenario<Integer> emptyList_addToRearC_C;
    private Scenario<Integer> A_removeLast_emptyList;
    private Scenario<Integer> A_removeA_emptyList;
    private Scenario<Integer> A_removeFirst_emptyList;
    private Scenario<Integer> A_ListIterIndex1PreviousRemoveA_emptyList;
    private Scenario<Integer> B_removeB_emptyList;
    private Scenario<Integer> B_remove0_emptyList;
    private Scenario<Integer> B_removeFirst_emptyList;
    private Scenario<Integer> B_removeLast_emptyList;
    private Scenario<Integer> C_removeC_emptyList;
    private Scenario<Integer> B_IterRemoveB_emptyList;
    private Scenario<Integer> C_remove0_emptyList;
    private Scenario<Integer> C_IterRemoveC_emptyList;
    private Scenario<Integer> C_removeFirst_emptyList;
    private Scenario<Integer> C_removeLast_emptyList;
    private Scenario<Integer> A_IterAddB_BA;
    private Scenario<Integer> A_ListIterNextAddB_AB;
    private Scenario<Integer> A_ListIterIndex1PreviousAddB_BA;
    private Scenario<Integer> A_set0A_A;
    private Scenario<Integer> A_set0C_C;
    private Scenario<Integer> A_ListIterIndex0NextASetB_B;
    private Scenario<Integer> A_ListIterIndex1PreviousSetB_B;
    private Scenario<Integer> B_set0A_A;
    private Scenario<Integer> B_set0B_B;
    private Scenario<Integer> B_set0C_C;
    private Scenario<Integer> C_set0A_A;
    private Scenario<Integer> C_set0B_B;
    private Scenario<Integer> C_set0C_C;
    private Scenario<Integer> AB_removeLast_A;
    private Scenario<Integer> AB_ListIterIndex1PreviousARemoveA_B;
    private Scenario<Integer> AB_ListIterIndex2PreviousBRemoveB_A;
    private Scenario<Integer> A_ListIterAddC_CAB;
    private Scenario<Integer> A_ListIterIndex0NextAddC_ACB;
    private Scenario<Integer> A_ListIterIndex1NextAddC_ABC;
    private Scenario<Integer> A_ListIterIndex1PreviousAddC_CAB;
    private Scenario<Integer> A_ListIterIndex2PreviousAddC_ACB;
    private Scenario<Integer> AB_set0A_AB;
    private Scenario<Integer> AB_set1A_AA;
    private Scenario<Integer> AB_set0B_BB;
    private Scenario<Integer> AB_set1B_AB;
    private Scenario<Integer> AB_set0C_CB;
    private Scenario<Integer> AB_set1C_AC;
    private Scenario<Integer> AB_ListIterIndex0NextSetC_CB;
    private Scenario<Integer> AB_ListIterIndex1NextSetC_AC;
    private Scenario<Integer> AB_ListIterIndex1PreviousSetC_CB;
    private Scenario<Integer> AB_ListIterIndex2PreviousSetC_AC;
    private Scenario<Integer> ABC_ListIterIndex1PreviousRemoveA_BC;
    private Scenario<Integer> ABC_ListIterIndex2PreviousRemoveB_AC;
    private Scenario<Integer> ABC_ListIterIndex3PreviousRemoveC_AB;
    private Scenario<Integer> ABC_set0C_CBC;
    private Scenario<Integer> ABC_set1C_ACC;
    private Scenario<Integer> ABC_set2C_ABC;
    private Scenario<Integer> ABC_ListIterIndex0NextSetD_DBC;
    private Scenario<Integer> ABC_ListIterIndex1NextSetD_ADC;
    private Scenario<Integer> ABC_ListIterIndex2NextSetD_ABD;
    private Scenario<Integer> ABC_ListIterIndex1PreviousSetD_DBC;
    private Scenario<Integer> ABC_ListIterIndex2PreviousSetD_ADC;
    private Scenario<Integer> ABC_ListIterIndex3PreviousSetD_ABD;
	...
	private void runTests() {
        ...
        testEmptyList(A_ListIterIndex1PreviousRemoveA_emptyList, "A_ListIterIndex1PreviousRemoveA_emptyList");
        ...
        testTwoElementList(A_ListIterIndex1PreviousAddB_BA, "A_ListIterIndex1PreviousAddB_BA", LIST_BA, STRING_BA);
        ...
        testSingleElementList(A_ListIterIndex0NextASetB_B, "A_ListIterIndex0NextASetB_B", LIST_B, STRING_B);
        testSingleElementList(A_ListIterIndex1PreviousSetB_B, "A_ListIterIndex1PreviousSetB_B", LIST_B, STRING_B);
        ...
        testThreeElementList(A_ListIterAddC_CAB, "A_ListIterAddC_CAB", LIST_CAB, STRING_CAB);
        testThreeElementList(A_ListIterIndex0NextAddC_ACB, "A_ListIterIndex0NextAddC_ACB", LIST_ACB, STRING_ACB);
        testThreeElementList(A_ListIterIndex1NextAddC_ABC, "A_ListIterIndex1NextAddC_ABC", LIST_ABC, STRING_ABC);
        testThreeElementList(A_ListIterIndex1PreviousAddC_CAB, "A_ListIterIndex1PreviousAddC_CAB", LIST_CAB, STRING_CAB);
        testThreeElementList(A_ListIterIndex2PreviousAddC_ACB, "A_ListIterIndex2PreviousAddC_ACB", LIST_ACB, STRING_ACB);
        ...
        testTwoElementList(AB_ListIterIndex0NextSetC_CB, "AB_ListIterIndex0NextSetC_CB", LIST_CB, STRING_CB);
        testTwoElementList(AB_ListIterIndex1NextSetC_AC, "AB_ListIterIndex1NextBSetC_AC", LIST_AC, STRING_AC);
        testTwoElementList(AB_ListIterIndex1PreviousSetC_CB, "AB_ListIterIndex1PreviousSetC_CB", LIST_CB, STRING_CB);
        testTwoElementList(AB_ListIterIndex2PreviousSetC_AC, "AB_ListIterIndex2PreviousSetC_AC", LIST_AC, STRING_AC);
        ...
        testTwoElementList(ABC_ListIterIndex1PreviousRemoveA_BC, "ABC_ListIterIndex1PreviousRemoveA_BC", LIST_BC, STRING_BC);
        testTwoElementList(ABC_ListIterIndex2PreviousRemoveB_AC, "ABC_ListIterIndex2PreviousRemoveB_AC", LIST_AC, STRING_AC);
        testTwoElementList(ABC_ListIterIndex3PreviousRemoveC_AB, "ABC_ListIterIndex3PreviousCRemoveC_AB", LIST_AB, STRING_AB);
        ...
        testThreeElementList(ABC_ListIterIndex0NextSetD_DBC, "ABC_ListIterIndex0NextSetD_DBC", LIST_DBC, STRING_DBC);
        testThreeElementList(ABC_ListIterIndex1NextSetD_ADC, "ABC_ListIterIndex1NextSetD_ADC", LIST_ADC, STRING_ADC);
        testThreeElementList(ABC_ListIterIndex2NextSetD_ABD, "ABC_ListIterIndex2NextSetD_ABD", LIST_ABD, STRING_ABD);
        testThreeElementList(ABC_ListIterIndex1PreviousSetD_DBC, "ABC_ListIterIndex1PreviousSetD_DBC", LIST_DBC, STRING_DBC);
        testThreeElementList(ABC_ListIterIndex2PreviousSetD_ADC, "ABC_ListIterIndex2PreviousSetD_ADC", LIST_ADC, STRING_ADC);
        testThreeElementList(ABC_ListIterIndex3PreviousSetD_ABD, "ABC_ListIterIndex3PreviousSetD_ABD", LIST_ABD, STRING_ABD);
...
//			break;
    ...
    /**
     * Scenario: [A,B] -> addToRear(C) -> [A,B,C] Required to start with a three
     * element list
     *
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
        ...
        try {
            ...
            printTest(scenarioName + "_iterNextRemoveNext_testIterHasNext", testIterHasNext(iterAfterNext((IndexedUnsortedList<Integer>) iterAfterRemove(iterAfterNext(scenario.build(), 1)), 1), Result.False));
            printTest(scenarioName + "_iterNextRemoveNext_testIterNext", testIterNext(iterAfterNext((IndexedUnsortedList<Integer>) iterAfterRemove(iterAfterNext(scenario.build(), 1)), 1), null, Result.NoSuchElement));
            printTest(scenarioName + "_iterNextRemoveNext_testIterRemove", testIterRemove(iterAfterNext((IndexedUnsortedList<Integer>) iterAfterRemove(iterAfterNext(scenario.build(), 1)), 1), Result.NoException));
            // ListIterator
            if (SUPPORTS_LIST_ITERATOR) {
                //TODO: will add for double-linked list
            } else {
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
        ...
        try {
            ...
            printTest(scenarioName + "_iterNextRemove3_testIterHasNext", testIterHasNext(iterAfterRemove(iterAfterNext(scenario.build(), 3)), Result.False));
            printTest(scenarioName + "_iterNextRemove3_testIterNext", testIterNext(iterAfterRemove(iterAfterNext(scenario.build(), 3)), null, Result.NoSuchElement));
            printTest(scenarioName + "_iterNextRemove3_testIterRemove", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 3)), Result.IllegalState));
            // ListIterator
            if (SUPPORTS_LIST_ITERATOR) {
                //TODO: will add for double-linked list
            } else {
